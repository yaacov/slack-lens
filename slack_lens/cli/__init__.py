...
def main(argv: list[str] | None = None) -> None:
    ...
    # -- auth ----------------------------------------------------------------
    p_auth = sub.add_parser("auth", help="Authenticate with Slack workspace")
    p_auth.add_argument(
        "--force",
        action="store_true",
    ...
    # -- channels ------------------------------------------------------------
    sub.add_parser("channels", help="List available channels").set_defaults(
        func=cmd_channels
    )
    ...
    # -- search --------------------------------------------------------------
    p_search = sub.add_parser("search", help="Search archived content")
